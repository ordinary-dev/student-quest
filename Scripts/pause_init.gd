...
func add_pause() -> void:
	...
	sc.name = "Pause"
	get_node("/root/ui/CanvasLayer").add_child(sc)
...
func enable_ui() -> void:
	...
	if OS.get_name() == "Android" or SHOW_CONTROLS:
		if !has_node("/root/ui/CanvasLayer/Controls"):
			add_controls()
...
func disable_ui() -> void:
	if has_node("/root/ui/CanvasLayer/Pause"):
		get_node("/root/ui/CanvasLayer").remove_child(get_node("/root/ui/CanvasLayer/Pause"))
	if has_node("/root/ui/CanvasLayer/Controls"):
		get_node("/root/ui/CanvasLayer").remove_child(get_node("/root/ui/CanvasLayer/Controls"))
